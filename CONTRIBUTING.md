...
- **Every public declaration is documented.** Files carry a `/-!` module
  ...
  `/--` doc-strings.
- **Naming** follows [mathlib conventions](https://leanprover-community.github.io/contribute/naming.html#capitalization):
...
- **Instance names**: give every handwritten public `instance` an explicit
  `inst<Class><TargetOrPredicate>` name, with a meaningful qualifier when needed
  (e.g. `instCodecTxOut`, `instDecidableMerkleCommits`). Instances generated by
  `deriving` keep their generated names; private and local instances may be
  anonymous.
